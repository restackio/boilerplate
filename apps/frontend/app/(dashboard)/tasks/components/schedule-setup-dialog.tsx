...
export function ScheduleSetupDialog({
  ...
  const dialogTitle = title || (isEditing ? "Edit schedule" : "Create schedule");
  const dialogSubmitLabel = submitLabel || (isEditing ? "Update" : "Create");
      ...
      <DialogContent className="max-w-2xl">
        ...
        <div className="flex justify-end space-x-2 pt-4">
          ...
          <Button onClick={handleSubmit} disabled={isSubmitting}>
            {isSubmitting ? (isEditing ? "Updating..." : "Creating...") : dialogSubmitLabel}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
