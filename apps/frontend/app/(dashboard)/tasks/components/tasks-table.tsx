...
export function createTaskColumnsConfig(
  ...
  return [
    ...
    dtf
      ...
      .id("created_by")
      .accessor((row: Task) =>
        row.schedule_task_id ? "Schedule" : row.created_by_name || "User",
      )
