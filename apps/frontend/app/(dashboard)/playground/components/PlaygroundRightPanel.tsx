...
import { PlaygroundTaskExecution } from "./PlaygroundTaskExecution";
          ...
          <Card className="h-full flex items-center justify-center">
            <CardContent className="text-center">
              <div className="text-muted-foreground">
                ...
                <p className="text-sm">Select an agent to compare</p>
          ...
          <Card className="h-full flex items-center justify-center">
            <CardContent className="text-center">
              <div className="text-muted-foreground">
                ...
                <p className="text-sm">Ready for comparison</p>
                <p className="text-xs mt-1">Create a task to start testing</p>
              </div>
            </CardContent>
          </Card>
        ) : (
