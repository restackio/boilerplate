...
export function IntegrationSetupTabSimplified({ server, onDataChange }: IntegrationSetupTabProps) {
      ...
      <div className="p-4 bg-blue-50 border border-blue-200 rounded-md">
        <div className="flex items-start gap-2">
          ...
          <div className="text-sm text-blue-700">
            <strong>Tool Management:</strong> Tools from this integration can now be configured individually for each agent. 
            Go to an agent's setup page to discover and configure tools with custom descriptions and approval settings.
          </div>
        </div>
      </div>
    </div>
