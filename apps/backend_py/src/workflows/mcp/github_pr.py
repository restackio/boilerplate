...
class GitHubPRWorkflow:
    """Workflow to create a GitHub Pull Request using AI."""

    @workflow.run
    async def run(self, workflow_input: GitHubPRInput) -> GitHubPROutput:
        log.info("GitHubPRWorkflow started", input=workflow_input)
...
Return the complete JSON structure following the GitHub API format."""
            ...
            error_message = f"Error during GitHubPRWorkflow: {e}"
